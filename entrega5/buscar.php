...
<body>
  ...
  foreach ($dataCollected as $resp) {  
    echo "<tr>
             ...
             <td>$resp[3]</td> 			 
			 <td> 
			    <form action='consultas/consulta_ver_habit_de_hotel.php' method='post'>
  ...
  foreach ($dataCollected1 as $resp) {  
    echo "<tr>
		     <td>$resp[1]</td>			 
			 <td> 
			    <form action='consultas/consulta_ver_plato_de_restaurante.php' method='post'>
  ...
  foreach ($dataCollected2 as $resp) {  
    echo "<tr>
		     <td>$resp[1]</td>			 
			 <td> 
			    <form action='consultas/consulta_ver_tours_de_agencia.php' method='post'>
  ...
  $query3 = "SELECT *
            FROM parques P 
      WHERE P.nombre_parque LIKE '%$preg%';";
    ...
    echo "<tr>
       ...
       <td> 
          ...
          <input type='hidden' id='tarifa' name='tarifa' value='$resp[5]'>
                <button type='submit' class='btn btn-secondary'>Ver parque</button>                
        </form>
       </td>
      </tr>";
