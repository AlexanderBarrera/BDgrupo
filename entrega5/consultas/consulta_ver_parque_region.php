...
<body>
  ...
  echo "<h1> Seleccionar el parque de la región $var2</h1>";

  $query = "SELECT P.pid, P.nombre_parque, P.hectareas, P.tarifa, P.descripcion
            FROM parques P WHERE P.rid = $var1;";
